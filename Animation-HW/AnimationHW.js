...
lib.ssMetadata = [
		{name:"AnimationHW_atlas_1", frames: [[0,96,600,80],[0,0,600,94]]}
];
...
(lib.CachedBmp_2 = function() {
	this.initialize(ss["AnimationHW_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#111111").s().p("AkaEbQh1h2AAilQAAilB1h1QB2h1CkAAQClAAB2B1QB1B1AAClQAAClh1B2Qh2B1ilAAQikAAh2h1g");
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#111111").s().p("AkaEaQh1h0AAimQAAikB1h2QB2h1CkAAQCmAAB0B1QB2B2AACkQAACmh2B0Qh0B2imAAQikAAh2h2g");
...
}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(0,0,80,80), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,1,1).p("EgXbgshMAu3AAAMAAABZDMgu3AAAg");
	this.shape.setTransform(150,285);
...
p.nominalBounds = new cjs.Rectangle(-1,-1,302,572);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0.05,9.75,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_2();
	this.instance_1.setTransform(0.05,13.75,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},2).wait(2));

	// Body
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#97BEBB").s().p("A2pFeQgyAAAAhGIAAovQAAhGAyAAMAtTAAAQAyAAAABGIAAIvQAABGgyAAg");
	this.shape.setTransform(150,35);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#97D8C7").s().p("A2pFeQgyAAAAhGIAAovQAAhGAyAAMAtTAAAQAyAAAABGIAAIvQAABGgyAAg");
	this.shape_1.setTransform(150,35);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#97D8C7").s().p("AznD6QgsAAAAgyIAAmPQAAgyAsAAMAnQAAAQArAAAAAyIAAGPQAAAygrAAg");
	this.shape_2.setTransform(150,35.05);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#97D8C7").s().p("A2pHCQgyAAAAgyIAAsfQAAgyAyAAMAtTAAAQAyAAAAAyIAAMfQAAAygyAAg");
	this.shape_3.setTransform(150,45);
...
p.nominalBounds = new cjs.Rectangle(0,0,300.1,90);
...
// stage content:
(lib.AnimationHW = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// ButtonThree
	this.FollowThrough = new lib.Button();
	this.FollowThrough.name = "FollowThrough";
	this.FollowThrough.setTransform(860,610);
	new cjs.ButtonHelper(this.FollowThrough, 0, 1, 2, false, new lib.Button(), 3);

	this.timeline.addTween(cjs.Tween.get(this.FollowThrough).wait(101));

	// ButtonTwo
	this.StartAnticipation = new lib.Button();
	this.StartAnticipation.name = "StartAnticipation";
	this.StartAnticipation.setTransform(474,609.75);
	new cjs.ButtonHelper(this.StartAnticipation, 0, 1, 2, false, new lib.Button(), 3);

	this.timeline.addTween(cjs.Tween.get(this.StartAnticipation).wait(101));
	...
	this.StartSquash.setTransform(250,645.05,1,1,0,0,0,150,35);
...
p.nominalBounds = new cjs.Rectangle(739,417.1,421.70000000000005,283);
// library properties:
lib.properties = {
	id: '298FEF2AD8E64CE0AB6AEEA3DE8FC2FF',
	width: 1280,
	height: 720,
	fps: 30,
	color: "#FFFFFF",
...
an.compositions['298FEF2AD8E64CE0AB6AEEA3DE8FC2FF'] = {
